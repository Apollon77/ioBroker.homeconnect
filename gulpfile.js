...
gulp.task('rename', function ()  {
    var newname;
    var author = 'dna909';
    var email  = 'dna909@googlemail.com';
    ...
    if (!newname) {
        console.log('Please write the new homeconnect name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/homeconnect.png')) {
        fs.renameSync(__dirname + '/admin/homeconnect.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/homeconnect.html')) {
        fs.renameSync(__dirname + '/widgets/homeconnect.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/homeconnect/js/homeconnect.js')) {
        fs.renameSync(__dirname + '/widgets/homeconnect/js/homeconnect.js', __dirname + '/widgets/homeconnect/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/homeconnect')) {
        fs.renameSync(__dirname + '/widgets/homeconnect',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /homeconnect/g,
        ...
        {
            match: /Homeconnect/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Homeconnect'
        },
        {
            match: /dna909/g,
            replacement: author
